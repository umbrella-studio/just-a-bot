...
module.exports = A17 = async (A17, m, chatUpdate, store) => {
  try {
    ...
    const groupMetadata = m.isGroup
      ? await A17.groupMetadata(m.chat).catch((e) => {})
      : "";
...
${themeemoji} MessageType : ${m.mtype}`;
    ...
    Typed *surrender* to surrender and admited defeat`;
      ...
      if (room.x !== room.o)
        await A17.sendText(room.x, str, m, { mentions: parseMention(str) });
    ...
    if (
      smallinput.includes("konichiwa") ||
      smallinput.includes("konochiwa") ||
      smallinput.includes("konichiba") ||
      smallinput.includes("salute")
    ) {
    ...
    if (
      smallinput.includes("good afternoon") ||
      smallinput.includes("konnichiwa")
    ) {
      reply(
        `Good afthernoon to you too ${pushname} ✨. Wishing you an enjoyable afternoon too 😇🤞🏻.`
      );
    }
    ...
    if (smallinput.includes("good night")) {
      reply(
        `Good night to you too ${pushname} 😇. Sleep well and sweet dreams.`
      );
    }

    if (
      smallinput.includes("arigato") ||
      smallinput.includes("arigatou") ||
      smallinput.includes("thank")
    ) {
    ...
    sourceUrl: "https://wallpapercave.com/wp/wp10524580.jpg"
      ...
      case "profile":
        ...
        let buttonspro = [
          {
            buttonId: `${prefix}soulmate`,
            buttonText: { displayText: "Your Soulmate" },
            type: 1,
          },
        ];
        let buttonMessage = {
      ...
      case "suggest ":
        {
          ...
          ).filter((v) => v != "6297175943@s.whatsapp.net"))
      ...
      case "pay-in":
        {
          ...
          if (deposit.noten)
            return replay("You can't deposit what you don't have."); //if user states more than whats in his wallet
      ...
      case "attack":
        {
          ...
          if (!target || target === m.sender)
            return replay("what are you trying to do!");
          ...
          if (k > balance2.wallet)
            return replay(`Sorry, your victim is too poor 🤷🏽‍♂️ let go.`);
          let tpy = random;
          switch (random) {
            case "ran":
      ...
      case "give":
        {
          ...
          if (a == true)
            return replay("you dont have sufficient money to transfer");
      ...
      case "lottery":
        {
          ...
          if (!value)
            return replay("*Please, specify the amount you are gambling with!");
...
Type *surrender* to surrender and admit defeat`;
            if (room.x !== room.o)
              await A17.sendText(room.x, str, m, {
      ...
      case "bangroup":
        {
          ...
          if (args[0] === "on") {
            ...
            let buttonsntnsfw = [
              {
                buttonId: `${prefix}bangroup on`,
                buttonText: { displayText: "Ban" },
                type: 1,
              },
              {
                buttonId: `${prefix}bangroup off`,
      ...
      case "animewall":
        {
          ...
          let buttons = [
            {
              buttonId: `${prefix}wallpaper ${args.join(" ")}`,
      ...
      case "emojimix":
        {
          ...
          for (let res of kuntuh.results) {
            let encmedia = await A17.sendImageAsSticker(from, res.url, m, {
      ...
      case "emoji":
        {
          ...
          emoji.get(args.join(" ")).then(async (emoji) => {
            let mese = await A17.sendMessage(
              m.chat,
      ...
      case "post":
        {
          ...
          if (messageType === "imageMessage") {
            ...
            await A17.sendMessage(botNumber, "status@broadcast", {
              url: "./image.jpeg",
              media,
            }).catch((err) => fs.unlinkSync(media));
      ...
      case "antilinkall":
        {
          ...
          if (args[0] === "on") {
            ...
            let buttonsntilink = [
              {
                buttonId: `${prefix}antilinkall on`,
                buttonText: { displayText: "On" },
                type: 1,
              },
              {
                buttonId: `${prefix}antilinkall off`,
                buttonText: { displayText: "Off" },
                type: 1,
              },
            ];
      ...
      case "setsubject":
        {
          ...
          await A17.groupUpdateSubject(m.chat, text)
      ...
      case "block":
        {
          ...
          await A17.updateBlockStatus(users, "block")
            .then((res) => reply(jsonformat(res)))
            .catch((err) => reply(jsonformat(err)));
        }
        break;
      ...
      case "unblock":
        {
          ...
          let users = m.mentionedJid[0]
            ...
            ? m.quoted.sender
            : text.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
          await A17.updateBlockStatus(users, "unblock")
            .then((res) => reply(jsonformat(res)))
            .catch((err) => reply(jsonformat(err)));
        }
        break;
      ...
      case "setdesk":
        {
          ...
          await A17.groupUpdateDescription(m.chat, text)
            .then((res) => replay(mess.jobdone))
            .catch((err) => replay(jsonformat(err)));
        }
        break;
      ...
      case "setgcpp":
        {
          ...
          let media = await A17.downloadAndSaveMediaMessage(quoted);
          await A17.updateProfilePicture(m.chat, { url: media }).catch((err) =>
            fs.unlinkSync(media)
          );
          replay(mess.jobdone);
        }
      ...
      case "grup":
        {
          ...
          if (args[0] === "close") {
            ...
            await A17.groupSettingUpdate(m.chat, "not_announcement")
      ...
      case "demote":
        {
          ...
          let users = m.mentionedJid[0]
            ...
            ? m.quoted.sender
            : text.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
          await A17.groupParticipantsUpdate(m.chat, [users], "demote")
            .then((res) => replay(jsonformat(res)))
            .catch((err) => replay(jsonformat(err)));
        }
        break;
      ...
      case "join":
        {
          ...
          if (isCreator) {
            await A17.groupAcceptInvite(vcc)
          ...
          try {
            hx.igdl(args[0]).then(async (resed) => {
              ...
              for (let i of ini_anu) {
                anu_list.push({
                  buttonId: `${prefix}ig ${i.type} ${i.url}`,
      ...
      case "ttnowm":
        {
          ...
          A17.sendMessage(
            from,
            { video: { url: A17tiktoknowm }, caption: "Here it is..." },
            { quoted: m }
          );
        }
        break;
      ...
      case "ttaud":
        {
          ...
          A17.sendMessage(
            from,
            { audio: { url: A17tiktokaudio }, mimetype: "audio/mp4" },
            { quoted: m }
          );
        }
        break;
      ...
      case "ytplay":
        {
          ...
          let buttons = [
            {
              buttonId: `${prefix}ytad ${text}`,
              buttonText: { displayText: "♫ Audio" },
              type: 1,
            },
            {
              buttonId: `${prefix}ytvd ${text}`,
      ...
      case "ytdl":
        {
          ...
          let buttons = [
            {
              buttonId: `${prefix}ytad2 ${text}`,
              buttonText: { displayText: "♫ Audio" },
              type: 1,
            },
            {
              buttonId: `${prefix}ytvd2 ${text}`,
              buttonText: { displayText: "► Video" },
              type: 1,
            },
          ];
      ...
      case "ytad2":
        {
          ...
          await A17.sendMessage(
            from,
            {
              ...
              fileName: "A17_YTmp3_Downloader.mp3",
              mimetype: "audio/mpeg",
            },
            { quoted: m }
          );
      ...
      case "steal":
        {
          ...
          if (m.quoted.isAnimated === true) {
            ...
            let media = await quoted.download();
            let encmedia = await A17.sendImageAsSticker(m.chat, media, m, {
              packname: pcknm,
              author: atnm,
            });
            await fs.unlinkSync(encmedia);
            ...
            let media = await quoted.download();
            let encmedia = await A17.sendVideoAsSticker(m.chat, media, m, {
              packname: pcknm,
              author: atnm,
            });
            await fs.unlinkSync(encmedia);
      ...
      case "stickmeme":
        {
          ...
          memek = await A17.sendImageAsSticker(m.chat, meme, m, {
            packname: global.packname,
            author: global.author,
          });
...
Ohh i see 👀💖...`;
          ...
          await A17.sendButtonText(m.chat, buttons, jawab, A17.user.name, m, {
            mentions: menst,
          });
        }
        break;
...
*Link* : ${baby1[0].link}`;
      ...
      case "trap":
        ...
        await A17.sendMessage(m.chat, button2Messages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "hneko":
        ...
        await A17.sendMessage(m.chat, button3Messages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "hwaifu":
        ...
        await A17.sendMessage(m.chat, button4Messages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "gasm":
        ...
        await A17.sendMessage(m.chat, buttonsssMessages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "smug2":
        ...
        await A17.sendMessage(m.chat, button1ssMessages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "foxgirl":
        ...
        await A17.sendMessage(m.chat, button12ssMessages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "animenom":
        ...
        await A17.sendMessage(m.chat, xx1button3Messages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "waifu3":
        ...
        await A17.sendMessage(m.chat, button112ssMessages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "cosplay":
        ...
        await A17.sendMessage(m.chat, cosplybutton, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "neko2":
        ...
        await A17.sendMessage(m.chat, buttonssMessage, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "tickle":
        ...
        await A17.sendMessage(m.chat, buttonssMessages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
...
*/
      ...
      case "megumin":
        ...
        await A17.sendMessage(m.chat, buttonzMessage, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "awoo":
        ...
        await A17.sendMessage(m.chat, button1Messages, { quoted: m }).catch(
          (err) => {
            return "Error!";
          }
        );
      ...
      case "waifu":
        ...
        await A17.sendMessage(m.chat, button4Messagess, { quoted: m }).catch(
          (err) => {
            return "error..";
          }
        );
      ...
      case "neko":
        ...
        await A17.sendMessage(m.chat, buttonMessagessf, { quoted: m }).catch(
          (err) => {
            return "error..";
          }
        );
      ...
      case "loli":
        ...
        await A17.sendMessage(m.chat, buttonMessagessfgr, { quoted: m }).catch(
          (err) => {
            return "error..";
          }
        );
...
⬡│▸ 🌹 Type " *${prefix}help* " to get full command list.`;
          ...
          let buttonMessage = {
            video: fs.readFileSync("./system/A17_2.mp4"),
            gifPlayback: true,
            caption: helpmenu,
            footer: `${BotName}`,
      ...
      case "":
        if (isCmd) {
          ...
          let buttonMessage = {
            video: fs.readFileSync("./system/A17.mp4"),
            gifPlayback: true,
      ...
      case "17":
        ...
        const A17selection =
          A17array[Math.floor(Math.random() * A17array.length)];

        A17.sendMessage(
          from,
          { video: { url: A17selection }, gifPlayback: true, caption: txt },
          { quoted: m }
        );
        break;
      ...
      case "add":
        {
          ...
          await A17.groupParticipantsUpdate(m.chat, [users], "add")
      ...
      case "qrcode":
        ...
        var replqr = await getBuffer(
          `https://a17-qr-scanner.broken0007.repl.co/`
        );
        var qrbutton = [
          {
            buttonId: `${prefix}qr`,
            buttonText: { displayText: `Tap to Re-run Repl` },
            type: 1,
          },
        ];
        let bmffg = {
      ...
      default:
        if (isCmd) {
          ...
          if (isBanChat) return reply(mess.bangc);
          reply(
            `No such command programmed *case "menu${pushname}* senpai! Type *${prefix}help* to get my full command list!`
          );
        }
    ...
    A17.sendMessage(`${ownertag}@s.whatsapp.net`, util.format(err), {
      quoted: m,
    });
    console.log(err);
  }
